...
int8_t Joystick_get_x();		//gibt x Wert zwischen -32 und +32 zurück

int8_t Joystick_get_y();		//gibt y Wert zwischen -32 und +32 zurück



BOOL Joystick_get_b1();	// gibt 1 zurück wenn Button 1 gedrückt ist sonst 0

BOOL Joystick_get_b2();	// gibt 1 zurück wenn Button 2 gedrückt ist sonst 0
